...
#ifndef SUNRARE_SWIFT_H
#define SUNRARE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SunRare",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7SunRare14ARCameraScreen")
@interface ARCameraScreen : UIViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC7SunRare20ARWallArtworkControl")
@interface ARWallArtworkControl : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class ARCoachingOverlayView;

@interface ARWallArtworkControl (SWIFT_EXTENSION(SunRare)) <ARCoachingOverlayViewDelegate>
...
@interface ARWallArtworkControl (SWIFT_EXTENSION(SunRare)) <ARSCNViewDelegate>
