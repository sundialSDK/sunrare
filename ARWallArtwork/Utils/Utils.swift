...
public extension ARWallArtworkControl {
    ...
    struct Configuration {
        ...
        /**
         True - coaching will disppear when some real wall detected and (if some initial world map set) some saved artwork node detected. False - only some real wall detected.
